...
public class ItemMultiMachine extends ItemBlockRailcraftMultiType {

    private final BlockMultiMachine machineBlock;

    public ItemMultiMachine(Block block) {
        super(block);
        this.machineBlock = (BlockMultiMachine) block;
