...
public class MachineLiquidUnloader extends Machine {

    public static final IIcon[] pipeTexture = new IIcon[6];

    public MachineLiquidUnloader(Module module, Block block, Class<? extends TileMachineBase> tile, String tag) {
